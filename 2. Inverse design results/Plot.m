...
%                 j
                ...
                if dot(faNormal(j,:),Lightpoint)>0
                    patch('Faces',Polyhedron(i).face{j},'Vertices',Polyhedron(i).node,'FaceColor',excolor,'facealpha',trans,'LineWidth',0.01,'EdgeColor','k'); %,,'edgealpha',0.1
                elseif dot(faNormal(j,:),Lightpoint)<=0
                    patch('Faces',Polyhedron(i).face{j},'Vertices',Polyhedron(i).node,'FaceColor',incolor,'facealpha',trans,'LineWidth',0.01,'EdgeColor','k'); %,'k','edgealpha',0.1
                end
            end
        end
    end
